...
export const PERMISSION_CATALOG: PermissionCatalogItem[] = [
  ...
  },
  {
    ...
    name: "Taşıma Birimlerini Görüntüleme",
  ...
  },
  {
    ...
    name: "Taşıma Birimlerini Yönetme",
    module: "HANDLING_UNIT",
    description:
...
export const DEFAULT_ROLE_CATALOG: DefaultRoleCatalogItem[] = [
  ...
  {
    code: "PICKING_OPERATOR",
    name: "Toplama Operatörü",
    description:
  ...
  },
  {
    ...
    name: "RF Operatörü",
    description:
      "RF terminalindeki kabul, adresleme, transfer ve toplama işlemlerini yürütür.",
    permissionCodes: [
      "WAREHOUSE_VIEW",
      "LOCATION_VIEW",
      "INVENTORY_VIEW",
