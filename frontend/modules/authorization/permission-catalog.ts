...
export const PERMISSION_CATALOG:
  PermissionCatalogItem[] = [
    ...
    {
      code: "WAVE_SORTING_EXECUTE",
      name: "Manuel Dalga Ayrıştırma",
      module: "WAVE",
      description: "RF terminalinden dalga bazlı manuel ürün ayrıştırma işlemlerini yürütür.",
    },
    {
      code: "THM_MANAGE",
      name: "Dalga THM Yönetimi",
      module: "WAVE",
    ...
    },
    {
      ...
      module: "WAVE",
      description: "Etken yerel Put-to-Light tanım ve oturumlarını yönetir.",
    },
      {
