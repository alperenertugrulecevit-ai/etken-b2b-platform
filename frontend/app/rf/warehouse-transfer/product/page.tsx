...
import RFWarehouseProductTransferForm from "@/components/rf/warehouse-transfer/RFWarehouseProductTransferForm";
...
export default async function RFWarehouseProductTransferPage() {
  ...
  return (
    <section className="space-y-4">
      ...
      <RFWarehouseProductTransferForm warehouses={warehouses} />
    </section>
  );
}
