...
export default function SalesOrderImportUploadForm() {
  const router =
    useRouter();
  ...
  return (
    ...
    >
      <div className="flex flex-wrap items-start justify-between gap-4">
        ...
        <a
          href="/admin/data-imports/templates/sales-order"
